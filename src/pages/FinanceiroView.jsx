        ...
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4 transition-opacity">
          <div className="bg-white dark:bg-slate-900 rounded-2xl w-full max-w-4xl max-h-[90vh] overflow-hidden shadow-2xl flex flex-col">
            ...
            <div className="p-6 overflow-y-auto flex-1 bg-slate-50/50 dark:bg-slate-900">
              <form id="financeiroForm" onSubmit={handleSubmit} className="space-y-8">
                ...
                <div className="grid grid-cols-2 gap-8">
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <select name="contrato" value={formData.contrato} onChange={handleInputChange} required className="w-full px-4 py-2 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg text-sm text-slate-800 dark:text-slate-200 focus:outline-none focus:ring-2 focus:ring-blue-500/50">
